...
let users = [
    {id:1, login: 'user1', password: '123', email: 'user1@email.ru', products_list: []},
    {id:2, login: 'user2', password: '123', email: 'user2@email.ru', products_list: []},
    {id:3, login: 'user3', password: '123', email: 'user3@email.ru', products_list: []},
]
